<template>
  ...
  >
    ...
    >
      ...
      >
        <inertia-link :active="route().current('welcome')"
      ...
      >
        <ul class="flex flex-col lg:flex-row list-none mr-auto" v-if="canLogin">
          <li class="flex items-center" v-if="$page.props.user">
            <inertia-link
